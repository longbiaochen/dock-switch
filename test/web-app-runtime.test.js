...
test("findChromeAppProcessPidFromPsOutput matches Chrome browser app launches", () => {
    const psOutput = [
        ...
        "299 /Applications/Chromium.app/Contents/MacOS/Chromium --app=https://x.com/?utm_source=homescreen&utm_medium=shortcut --profile-directory=Default",
        "301 /Applications/Google Chrome.app/Contents/MacOS/Google Chrome --app=https://x.com/?utm_source=homescreen&utm_medium=shortcut --profile-directory=Default"
    ].join("\n");
